#ifndef all_tran_dlt_h_
#define all_tran_dlt_h_
...
class dlt : public all_tran_base  
{
...
public:
dlt(const Mat<>& XXi,const Mat<>& xxi) : all_tran_base(XXi,xxi,11)  
        {tt="dlt";}

dlt(const Vec<> hh) : all_tran_base(hh,11)  
        {tt="dlt";}

dlt() : all_tran_base(11)  //for the case of composite transformation
        {tt="dlt";}
...
void fill_matrixes() {fill_matrixes_dlt();}
