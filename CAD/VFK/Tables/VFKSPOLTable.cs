...
{
    /*
     Tabulka obsahuje body polohopisu - čísla bodů a souřadnice polohy - měřené souřadnice,
    včetně odkazu na ZPMZ, které je určilo (toto ZPMZ se může lišit od
    ZPMZ, v rámci kterého je bod číslován).
     */
    [Serializable]
    public class VFKSPOLTable : VFKDataTableBase
    {
        public VFKSPOLTable()
        {
            Items=new List<VFKSPOLTableItem>();
        }
        public void addTableData(VFKSPOLTableItem aValue)
        {
            Items.Add(aValue);
            UpdateMaxValue(aValue.ID);
        }
        public List<VFKSPOLTableItem> Items
        {
            get;
            private set;
        }
    ...
    [Serializable]
    public class VFKSPOLTableItem : VFKDataTableBaseItem
    {
        ...
        [VFKDefinitionAttribute(DefinitionFieldType.Number, 12,0, true, 6)]
        ...
        public UInt32 KATUZE_KOD_MER
        {
            get;
            set;
        }
        [VFKDefinitionAttribute(DefinitionFieldType.Number, 5,0, false, 11)]
        public UInt32 CISLO_ZPMZ_MER
        {
            get;
            set;
        }
