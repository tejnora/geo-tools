...
namespace VFK
{
    ...
    public class ScaleList
    {
        ...
        public struct ScaleListItem
        {
            ...
            public UInt32 ScaleNumber { get; set; }
        }
    ...
    public class VFKDataContext : DataObjectBase<VFKDataContext>
    {
            ...
            : base(null, new StreamingContext())
        {
            ...
            {
                new CilImportuEntry(dictionary.Translate("86", "Text", "DosavadniStav", typeof(string)) as string,
                    VFKMain.StavData.Pritomnoust),
                new CilImportuEntry(dictionary.Translate("87", "Text", "NovyStav", typeof(string)) as string,
                    VFKMain.StavData.Budoucnost)
            };
        ...
        protected override void ValidateFields()
        {
            ...
            if (FSU.ToString().Length != 6)
                SetFieldError(FSUProperty,
                    (string)dictionary.Translate("82", "Text", "FSU musí mít 6 čísel", typeof(string)));
            ...
            if (!(CisloZPMZ > 0 && CisloZPMZ <= 99999))
                SetFieldError(CisloZPMZProperty,
                    (string)dictionary.Translate("83", "Text", "ZPMZ musí mít 4 čísel", typeof(string)));
        }
        ...
        public class CilImportuEntry
        {
            ...
            public VFKMain.StavData StavData { get; set; }
        }
        ...
        public readonly PropertyData CilImportuProperty =
            RegisterProperty("CilImportuEntrie", typeof(CilImportuEntry), new CilImportuEntry());
        ...
        public readonly PropertyData KatastralniPracovisteProperty =
            RegisterProperty("KatastralniPracoviste", typeof(string), string.Empty);
        ...
        public readonly PropertyData KatastralniUzemiProperty =
            RegisterProperty("KatastralniUzemi", typeof(string), string.Empty);
        ...
        public readonly PropertyData PoradoveCisloKUProperty =
            RegisterProperty("PoradoveCisloKU", typeof(string), string.Empty);
        ...
        public readonly PropertyData VztazneMeritkoProperty = RegisterProperty("VztazneMeritko",
            typeof(ScaleList.ScaleListItem), Singletons.ScaleList.ScaleListItems[7]);
        ...
        public readonly PropertyData SouradnicovySystemProperty =
            RegisterProperty("SouradnicovySystem", typeof(SouradnicovySystem), SouradnicovySystem.SJTSK);
