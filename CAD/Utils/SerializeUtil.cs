...
namespace CAD.Utils
{
    ...
    class XmlUtil
    {
        ...
        public static void ParseProperty(XmlElement node, object dataobject)
        {
            ...
            PropertyInfo info = CAD.Tools.PropertyUtil.GetProperty(dataobject, fieldname);
    ...
    class PropertyUtil
    {
        public static object ChangeType(object value, Type type)
        {
            ...
            return CAD.Tools.PropertyUtil.ChangeType(value, type);
        }
        static public object Parse(string value, Type type)
        {
            if (type == typeof(UnitPoint))
                return CAD.Tools.PropertyUtil.Parse(new UnitPoint(0, 0), value);
            return CAD.Tools.PropertyUtil.Parse(value, type);
        }
    }
