...
namespace CAD.Utils
{
    ...
    {
        public static Point RightPoint(ICanvas canvas, Rect unitrect)
        {
            Point leftpoint = unitrect.Location;
            double x = leftpoint.X + unitrect.Width;
            double y = leftpoint.Y + unitrect.Height;
            return new Point(x, y);
        }
        public static Rect ToScreen(ICanvas canvas, Rect unitrect)
        {
            Rect r = new Rect();
            r.Location = canvas.ToScreen(new UnitPoint(unitrect.Location));
            if (unitrect.IsEmpty)
                return r;
            r.Width = Math.Round(canvas.ToScreen(unitrect.Width));
            r.Height = Math.Round(canvas.ToScreen(unitrect.Height));
            return r;
        }
        public static Rect ToUnit(ICanvas canvas, Rectangle screenrect)
        {
            UnitPoint point = canvas.ToUnit(new Point(screenrect.Location.X,screenrect.Location.Y));
            Size size = new Size(canvas.ToUnit(screenrect.Width), canvas.ToUnit(screenrect.Height));
            Rect unitrect = new Rect(point.Point, size);
            return unitrect;
        }
        public static Rect ToScreenNormalized(ICanvas canvas, Rect unitrect)
        {
            Rect r = ToScreen(canvas, unitrect);
            r.Y = r.Y - r.Height;
            return r;
        }
        public static Rect ToUnitNormalized(ICanvas canvas, Rectangle screenrect)
        {
            UnitPoint point = canvas.ToUnit(new Point(screenrect.Location.X,screenrect.Location.Y));
            Size size = new Size(canvas.ToUnit(screenrect.Width), canvas.ToUnit(screenrect.Height));
            Rect unitrect = new Rect(point.Point, size);
        ...
        public static Rectangle ConvertRect(Rect r)
        {
            return new Rectangle((int)r.Left, (int)r.Top, (int)r.Width, (int)r.Height);
        }
        public static Rectangle ConvertRect(System.Drawing.RectangleF r)
        {
            return new Rectangle((int)r.Left, (int)r.Top, (int)r.Width, (int)r.Height);
        }
        ...
        public static Rect GetRect(double x, double y, double w, double h)
        {
    ...
    {
        public static bool PointInPoint(UnitPoint p, UnitPoint tp, double tpThresHold)
        {
        ...
        public static Rect CircleBoundingRect(UnitPoint center, double radius)
        {
            Rect r = new Rect(center.Point, new Size(0, 0));
            r.Inflate(radius, radius);
            return r;
        }
        public static bool CircleHitPoint(UnitPoint center, double radius, UnitPoint hitpoint)
        {
        ...
        public static bool CircleIntersectWithLine(UnitPoint center, double radius, UnitPoint lp1, UnitPoint lp2)
        {
        ...
        public static bool IsPointInCircle(UnitPoint center, double radius, UnitPoint testpoint, double halflinewidth)
        {
        ...
        public static UnitPoint NearestPointOnCircle(UnitPoint center, double radius, UnitPoint testpoint, double roundToAngleD)
        {
            ...
            return new UnitPoint(center.X + dx,center.Y + dy);
        }
        public static UnitPoint TangentPointOnCircle(UnitPoint center, double radius, UnitPoint testpoint, bool reverse)
        {
        ...
        public static UnitPoint LineEndpoint(UnitPoint lp1, double angleR, double length)
        {
            ...
            return new UnitPoint(lp1.X + x, lp1.Y + y);
        }
        public static Rect LineBoundingRect(UnitPoint linepoint1, UnitPoint linepoint2, double halflinewidth)
        {
            ...
            Rect boundingrect = ScreenUtils.GetRect(x, y, w, h);
            boundingrect.Inflate(halflinewidth, halflinewidth);
            return boundingrect;
        }
        public static bool IsPointInLine(UnitPoint linepoint1, UnitPoint linepoint2, UnitPoint testpoint, double halflinewidth)
        {
        ...
        public static bool LineIntersectWithRect(UnitPoint lp1, UnitPoint lp2, Rect r)
        {
        ...
        public static UnitPoint CenterPointFrom3Points(UnitPoint p1, UnitPoint p2, UnitPoint p3)
        {
            ...
            return new UnitPoint(center_x, center_y);
        }
    }
    public class SelectionRectangle
    {
        Point m_point1;
        Point m_point2;
        public SelectionRectangle(Point mousedownpoint)
        {
        ...
        public void SetMousePoint(Graphics dc, Point mousepoint)
        {
            if (m_point2 != new Point())
        ...
        {
            double x = Math.Min(m_point1.X, m_point2.X);
            double y = Math.Min(m_point1.Y, m_point2.Y);
            double w = Math.Abs(m_point1.X - m_point2.X);
            double h = Math.Abs(m_point1.Y - m_point2.Y);
            if (m_point2 == new Point())
        ...
        public Rect Selection(ICanvas canvas)
        {
    ...
    public class MoveHelper
    {
        ...
        public void DrawObjects(ICanvas canvas, Rect r)
        {
            if (m_copies.Count == 0)
                return;
            canvas.DrawLine(canvas,System.Drawing.Pens.Wheat, canvas.ToScreen(OriginPoint), canvas.ToScreen(LastPoint));
    ...
    public class NodeMoveHelper
    {
        ...
        public Rect HandleMouseMoveForNode(UnitPoint mouseunitpoint)
        {
            Rect r = Rect.Empty;
            if (m_nodes.Count == 0)
                return r;
            r = new Rect(m_originPoint.Point, new Size(0, 0));
            r = Rect.Union(r, new Rect(mouseunitpoint.Point, new Size(0, 0)));
            if (m_lastPoint != UnitPoint.Empty)
                r = Rect.Union(r, new Rect(m_lastPoint.Point, new Size(0, 0)));
            ...
            foreach (INodePoint p in m_nodes)
            {
                if (r == Rect.Empty)
                    ...
                    r = Rect.Union(r, p.GetClone().GetBoundingRect(m_canvas));
        ...
        public void DrawOriginalObjects(ICanvas canvas, Rect r)
        {
