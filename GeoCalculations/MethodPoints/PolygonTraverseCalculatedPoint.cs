...
{
    class PolygonTraverseCalculatedPoint : CalculatedPointBase
    {
        ...
        readonly PropertyData _greatestPeakAngleProperty = RegisterProperty("GreaterPeakAngle", typeof(double), 0);
